...
public class GameUI extends JFrame {
    ...
    private void createGameUI() {
                        ...
                        if (actualPoint != null) {
                            ...
                            if (validateLine(actualPoint, finalPoint)) { // Is the line correct?
                                ...
                                if (validateSquare(x0, y0, x1, y1)) {
                                    ...
                                    squareCount++; // Increase square count.
        ...
        labelUser = new JLabel(User.getUser());
    ...
    private void doMove(boolean gameOwner, boolean square) {
        ...
        if (!square) moveCount++; // Increment moves count.
    ...
    private boolean lineExists(int x0, int y0, int x1, int y1) {
        ...
        for (int i = 0; i < intX0.length; i++) {
            ...
            if (x0 == actX0 && y0 == actY0)
                if (x1 == actX1 && y1 == actY1) return true;
        }
